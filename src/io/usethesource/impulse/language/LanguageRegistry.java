	...
	private static void updateMarkerResolutionRegistry() {
			...
			if (qfa != null) {
				for (String type : qfa.getSupportedMarkerTypes()) {
					String extension = ""
						...
						+ "   class=\"io.usethesource.impulse.editor.internal.quickfix.MarkerResolutionGenerator\""
						+ "   markerType=\"" + type + "\">"
		...
		for (IConfigurationElement element : reg
			...
			if (element
					.getAttribute("class")
					.equals(
							"io.usethesource.impulse.editor.internal.quickfix.MarkerResolutionGenerator")) {
