...
import io.usethesource.impulse.services.IOutlineImage;
...
public class DefaultOutlineImage implements IOutlineImage
{
	...
	private static ImageDescriptor OUTLINE_ITEM_DESC= AbstractUIPlugin.imageDescriptorFromPlugin("io.usethesource.impulse.runtime", IMAGE_ROOT + "/outline_item.gif");
